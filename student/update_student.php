...
session_start();
    ...
    if(isset($_POST['update_student'])){
        ...
        $query="UPDATE student SET Full_name='$name',Gender='$gender',Email='$email',Phone_number='$phone',Address='$address',Department='$department',SemAndClass='$class',Admission_no='$adno' WHERE Id=$id";
        //$query="UPDATE student SET (Full_name,Gender,Email,Phone_number,Address,Department,SemAndClass,Admission_no) VALUES ($name,$gender,$email,$phone,$address,$department,$class,$adno) WHERE Id=$id";
    ...
    <center>
        ...
        <div class="div_deg">
            ...
            <div>
                    ...
                    <input type="text" name="name" value="<?php echo "{$info['Full_name']}"; ?>" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="class" value="<?php echo "{$info['SemAndClass']}"; ?>" required>
                </div>

                <div>
                    <label>Admission no</label>
                    <input type="text" name="ad_no" value="<?php echo "{$info['Admission_no']}"; ?>" required>
                </div>
